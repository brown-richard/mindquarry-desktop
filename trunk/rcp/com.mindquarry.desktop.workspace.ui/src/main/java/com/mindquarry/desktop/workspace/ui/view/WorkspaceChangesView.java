package com.mindquarry.desktop.workspace.ui.view;
...
public class WorkspaceChangesView extends ViewPart {
    public static final String ID = "com.mindquarry.desktop.suite.view.workspace";
