...
public class ImageHelper {
    ...
    public static ImageAdaptor combine(BufferedImage image,
            BufferedImage overlay, int xoffset, int yoffset) {
        ImageAdaptor result = new ImageAdaptor(image.getWidth(), image
                .getHeight());
